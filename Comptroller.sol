    ...
    ExponentialNoError
{
    ...
    function _initializeMarket(address cToken) internal {
        // WARNING: safe32 will revert when block.timestamp exceeds 2^32 - 1 (4,294,967,295),
        // which is expected around year 2106. This will prevent new markets from being initialized.
        // Consider upgrading CompMarketState.block to uint64 or uint256 to support larger timestamps.
    ...
    function updateCompSupplyIndex(address cToken) internal {
        ...
        // WARNING: safe32 will revert when block.timestamp exceeds 2^32 - 1 around year 2106
        uint32 blockNumber = safe32(
            getBlockNumber(),
            "block number exceeds 32 bits"
        );
     ...
     * WARNING: Returns block.timestamp which will exceed uint32 max (2^32 - 1) around year 2106,
     * potentially causing reverts in functions that cast to uint32.
     */
